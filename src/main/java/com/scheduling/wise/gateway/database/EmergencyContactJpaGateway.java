...
public class EmergencyContactJpaGateway implements com.scheduling.wise.gateway.EmergencyContactGateway {
    ...
    @Override
    public EmergencyContactEntity save(EmergencyContact emergencyContact, PhoneEntity phoneEntity) {
        EmergencyContactEntity emergencyContactEntity = converter.toEntity(emergencyContact);
        emergencyContactEntity.setPhone(phoneEntity);
        return repository.save(emergencyContactEntity);
    }
